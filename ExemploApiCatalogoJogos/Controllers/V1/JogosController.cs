...
namespace ExemploApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        {
            return await NewMethod3(idJogo, jogoInputModel);
        }

        private async Task<ActionResult> NewMethod3(Guid idJogo, JogoInputModel jogoInputModel)
        {
            try
            {
        ...
        {
            return await NewMethod(idJogo, preco);
        }

        private async Task<ActionResult> NewMethod(Guid idJogo, double preco)
        {
            return await NewMethod1(idJogo, preco);
        }

        private async Task<ActionResult> NewMethod1(Guid idJogo, double preco)
        {
            try
            {
        ...
        {
            return await NewMethod2(idJogo);
        }

        private async Task<ActionResult> NewMethod2(Guid idJogo)
        {
            try
            {
